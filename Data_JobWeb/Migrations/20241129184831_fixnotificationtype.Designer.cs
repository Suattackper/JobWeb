...
namespace Data_JobWeb.Migrations
{
    ...
    [Migration("20241129184831_fixnotificationtype")]
    partial class fixnotificationtype
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data_JobWeb.Entity.JobSeekerNotificationType", b =>
                {
                    ...
                    b.Property<string>("IdJustForAdmin")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("id_justforadmin");

                    b.Property<DateTime?>("IsCreateAtJustForAdmin")
                        .HasColumnType("datetime")
                        .HasColumnName("is_create_at_justforadmin");

                    b.Property<bool?>("IsSeenJustForAdmin")
                        .HasColumnType("bit")
                        .HasColumnName("is_seen_justforadmin");
